...
export const Websites: ProjectDetails[] = [
  {
    ...
    highlights: [
      ...
      "Optimized image loading and skeleton component load state to reduce layout shift and boost first load speed",
      "Automated python script to modify images, including background removal",
      "Multi step client intake form with templated emails",
